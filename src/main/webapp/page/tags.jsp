...
<link type="text/css" rel="stylesheet" href="/my_blog/css/public.css" />
<link type="text/css" rel="stylesheet" href="/my_blog/css/tags.css" />
</head>
<body>
	...
	<div class="container" id="main">
		...
		<div class="row c_center">
				...
				<div id="list">
					<ul class="nav nav-pills">
  						...
  						<li role="presentation"><a href="/my_blog/category?get=all" id="common2"><span class="glyphicon glyphicon-list"></span>
								&nbsp;&nbsp;カテゴリー</a></li>
  						<li role="presentation" class="active"><a href="/my_blog/tag?get=all"><span class="glyphicon glyphicon-tags"></span>
								&nbsp;&nbsp;タグ</a></li>
			...
			<div class="list-group">
				...
				<a href="#" class="list-group-item active">タグ</a>
									
				<c:forEach var="map" items="${getTagAndArticle}">					
				<div class="tags_name">
				...
				<div>
					...
					<li class="list-group-item">
						<div>
							<div>
								<div>
									<a href="./article?id=${list.id}" id="common2">${list.title}</a>
								</div>
								<div class="c_right">
