...
public class Form2Bean {
	...
	public static Article articleForm2Bean(HttpServletRequest request) throws FailException {
		...
		value.put("category", request.getParameter("category"));
		...
		throw new FailException("記事作成に失敗しました。");
	...
	private static boolean vilidate(Article a) {
		...
		if (a.getCategory() == null || a.getTitle() == null || a.getAuthor() == null || a.getTime() == null) {
			result = false;
		}
