...
public class Article implements Comparable {
	...
	public Article(int id, String title, String author, String category, String time, int star, int comment, int visit,
			String content) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", author=" + author + ", category=" + category + ", time=" + time
